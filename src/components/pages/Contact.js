        ...
        <section className="jumbotron text-left myAdj" id="addDarkGrey">
          <div className="container border rounded border border-dark bg-white"
            ...
            <div className="container mt-2">
              <div className="row">
                <h1 className="ml-0 mt-4">How to contact Joe Farrish</h1>
              </div>
              <div className="div">
                <hr />
              </div>
            ...
            <div className="col-dm-12 mb-4">
              <section alt="Download Joe Farrish's Resume.">
                <h4>You can view my resume  <a href="https://drive.google.com/file/d/1GKverFkQ2kJCvslThb2zZZ9K2_0wmKl7/view?usp=sharing">here</a></h4>
              </section>
            </div>
          </div>
        </section>
