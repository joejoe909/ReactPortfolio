          ...
          <section alt="A responsive image grid by Joe Farrish">
            ...
            <div className="row"> 
              <div className="col-md-4">
                <a href="https://farrishworks.com" target="_blank"> <img src={VBS} className="img-fluid p-4 m-2" alt="Checkout Visual Brainstorm by Farrish Works LLC. Software to help creatives build brainstorm trees capable of holding large amounts of information."/> </a>
              ...
              <div className="col-md-4">
                <a href="https://joejoe909.github.io/TimedQuiz/" target="_blank"> <img src={QzTmp}
                  className="img-fluid p-4 m-2" alt="With the world going remote, it's never been a better time to get into building a system that allows potential customers to quickly construt tests for students, job seekers, etc. This Template provides a colorful starting point and the necessary logic tobegin that venture!"/></a>
              ...
              <div className="col-md-4">
                <a href="https://joejoe909.github.io/Ez-Geo-Tracker/" target="_blank"> <img src={EGT} className="img-fluid p-4 m-2" alt="Responsive image"/> </a>
              ...
              <div className="col-md-4"> 
                <a href="https://joejoe909.github.io/Weather-Dashboard/" target="_blank"> <img src={wdb} className="img-fluid p-4 m-2" alt="Responsive image"/> </a>
